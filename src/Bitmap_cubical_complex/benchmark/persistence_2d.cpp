...
int main() {
  ...
  double global_min = Gudhi::persistence_on_rectangle_from_top_cells(data.data(), sizes[1], sizes[0], out, out);
  ...
  std::size_t gm = Gudhi::persistence_on_rectangle_from_top_cells<true>(data.data(), sizes[1], sizes[0], outi, outi);
